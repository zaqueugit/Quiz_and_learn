					...
					setTimeout(function() {
						...
						switch(instrucoes_id) {
							...
							case 3:
								...
								$("#instrucoes").css("background-color","#00b69f");
								break;
						}
						if(instrucoes_id !=4){
							$(".begin_quiz").show();
							...
							$(".placar").hide();
							if(coins >100){
								var texto_fim = "Parabéns, você conseguiu concluir o teste! <br/>"
								//<a href='assets/images/interrogacao.png' download>Clique aqui e faça o download! </a>";
							}else{
								var texto_fim = "Infelizmente você só conseguiu "+coins+" Acertos, Tente novamente!";
							}
